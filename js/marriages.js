...
const buildBirthDeathChart = async() => {
    ...
    jsonQuery.query[2].selection.values = ["vm2126", "vm3136"] // marriages and divorces
    ...
    for (let i = 0; i < values.length; i += 2) {
        marriages.push(values[i]);    
        divorces.push(values[i + 1]);  
    }
    ...
    const chart = new frappe.Chart("#chart", {
        title: `Marriages and Divorces in ${getChosenArea()}`,
        data: chartData,
        height: 450,
        type: "bar",
